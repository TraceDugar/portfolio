  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        ...
        {/* Github  Corner Link */}
        <a href="https://github.com/TraceDugar" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{height: '100%'}}>
          <div className="col-md-12">
            <div>
              <span className="iconify header-icon" data-icon="zondicons:computer-desktop" data-inline="false"></span>
              <br/>
              <h1 className="mb-0">
                {name}
              </h1>
